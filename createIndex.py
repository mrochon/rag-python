...
file_path = os.path.join(os.getcwd(), "REST/createIndex.json")
...
# request = f"grant_type=client_credentials&client_id={CLIENT_ID}&client_secret={CLIENT_SECRET}&scope=https://management.azure.com/.default"
